<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-search">[scf-form-search]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs search input field.', 'shortcode-factory')?></p>
