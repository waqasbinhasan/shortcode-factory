<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-password">[scf-form-password]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs password input.', 'shortcode-factory')?></p>
