<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-container" data-has-closing="1">[scf-post-id]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs container with an HTML tag.', 'shortcode-factory')?></p>
