<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-tel">[scf-form-tel]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs phone number input field.', 'shortcode-factory')?></p>
