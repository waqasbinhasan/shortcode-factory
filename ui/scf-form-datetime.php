<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-datetime">[scf-form-datetime]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs date-time input field.', 'shortcode-factory')?></p>
