<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-text">[scf-form-text]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs single line text input.', 'shortcode-factory')?></p>
	<div class="scf-controls-group">
		...
		<div class="scf-control">
			<label for="scf-control-maxlength" class="scf-control-label"><?=__('Maximum Input Length', 'shortcode-factory')?> <span class="optional scf-right"><?=__('(optional)', 'shortcode-factory')?></span></label>
			<input type="text" id="scf-control-maxlength" name="scf-param-maxlength" class="scf-control-text scf-param" data-param-name="maxlength" />
		</div>
