<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-button" data-has-closing="1">[scf-form-button]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs clickable button.', 'shortcode-factory')?></p>
