<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-month">[scf-form-month]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs month input field.', 'shortcode-factory')?></p>
