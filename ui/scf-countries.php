<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-countries">[scf-countries]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs list of countries.', 'shortcode-factory')?></p>
	<div class="scf-controls-group">
		...
		<div class="scf-control">
			...
			<select id="scf-control-format" name="scf-param-format" class="scf-control-select scf-param" data-param-name="format">
				...
				<optgroup label="Ordered / Unordered List">
					<option value="ul-name">Country Name (default)</option>
					<option value="ul-name-iso">Country Name (ISO Code)</option>
					<option value="ul-iso">ISO Code</option>
					<option value="ul-iso-name">ISO Code - Country Name</option>
				</optgroup>
		...
		<div class="scf-control">
			...
			<span class="notes"><?=__('<strong>%%ISO%%</strong> = ISO Code; <strong>%%NAME%%</strong> = Country Name (default)', 'shortcode-factory')?></span>
		</div>
