<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-submit">[scf-form-submit]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs form submit button.', 'shortcode-factory')?></p>
	<div class="scf-controls-group">
		<div class="scf-control">
			<label for="scf-control-value" class="scf-control-label"><?=__('Value or Label', 'shortcode-factory')?> <span class="optional scf-right"><?=__('(optional)', 'shortcode-factory')?></span></label>
			<input type="text" id="scf-control-value" name="scf-param-value" class="scf-control-text scf-param" data-param-name="value" />
			<span class="notes"><?=__('Default value is "Submit".', 'shortcode-factory')?></span>
		</div>
