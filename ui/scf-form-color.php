<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-color">[scf-form-color]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs color input field.', 'shortcode-factory')?></p>
