<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-label" data-has-closing="1">[scf-form-label]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs label for fields.', 'shortcode-factory')?></p>
	<div class="scf-controls-group">
		<div class="scf-control">
			<label for="scf-control-for" class="scf-control-label"><?=__('Form Field ID', 'shortcode-factory')?> <span class="optional scf-right"><?=__('(optional)', 'shortcode-factory')?></span></label>
			<input type="text" id="scf-control-for" name="scf-param-for" class="scf-control-text scf-param" data-param-name="for" />
			<span class="notes"><?=__('Target field ID. Leave empty if you do not want to use it with a form or a field.', 'shortcode-factory')?></span>
		</div>
