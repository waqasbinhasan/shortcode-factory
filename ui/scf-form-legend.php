<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-legend" data-has-closing="1">[scf-form-legend]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs caption for a field set.', 'shortcode-factory')?></p>
