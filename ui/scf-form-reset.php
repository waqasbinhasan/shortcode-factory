<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-reset">[scf-form-reset]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs form reset button.', 'shortcode-factory')?></p>
	<div class="scf-controls-group">
		<div class="scf-control">
			...
			<span class="notes"><?=__('Default value is "Reset".', 'shortcode-factory')?></span>
		</div>
