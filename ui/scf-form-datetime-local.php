<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-datetime-local">[scf-form-datetime-local]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs local date-time input field.', 'shortcode-factory')?></p>
