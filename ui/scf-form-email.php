<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-email">[scf-form-email]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs email input field.', 'shortcode-factory')?></p>
