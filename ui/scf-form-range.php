<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-range">[scf-form-range]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs range input field.', 'shortcode-factory')?></p>
