<div class="scf-shortcode-wrapper">
	<h2 class="scf-shortcode-title" data-shortcode="scf-form-number">[scf-form-number]</h2>
	<p class="scf-shortcode-desc"><?=__('Outputs number input field.', 'shortcode-factory')?></p>
	<div class="scf-controls-group">
		...
		<div class="scf-control">
			<label for="scf-control-step" class="scf-control-label"><?=__('Step', 'shortcode-factory')?> <span class="optional scf-right"><?=__('(optional)', 'shortcode-factory')?></span></label>
			<input type="text" id="scf-control-step" name="scf-param-step" class="scf-control-text scf-param" data-param-name="step" />
			<span class="notes"><?=__('Default increment/decrement in values.', 'shortcode-factory')?></span>
		</div>
